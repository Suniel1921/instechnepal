...
//                         <h3 className='secondryHeading'>We Appreciate Your Feebacks Very Much</h3>

//                         <div className='testimonialsCard'>
//                             <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestiae ut eligendi, amet debitis, deserunt nisi assumenda quae voluptatum est nesciunt impedit velit dicta.</p>
    ...
    return (
        <div className='container'>
            <div className='testimonials'>
                ...
                <div className="right_testimonial">
                    <p className='title'>Testimonials</p>
                    <h3 className='secondryHeading'>We Appreciate Your Feedbacks Very Much</h3>
