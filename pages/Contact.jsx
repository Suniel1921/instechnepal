      ...
      <div className="contact_container">
        <div className="container contact">
          <div className='contact_content'>
            ...
            <p className='subPara'>Feel free to reach out to us anytime. We're eager to discuss ideas, collaborate, <br /> or answer any questions you may have. Let's connect and make great <br /> things happen together.</p>
          </div>
          {/* <div className="address">
            <div className='location'>
              <div className='address_image'><img src="" alt="" /></div>
              <div className="address_content">
                <h2>Address</h2>
                <p className='subPara'>kupondole,kathmandu,Nepal</p>
              </div>
            </div>
            <div className='location'>
            <div className='address_image'><img src="" alt="" /></div>
